...
<details>
<summary><b>Как работает логистическая регрессия</b></summary>
<div> <br />
	Работу данного алгоритма могут спросить на собесах в топ компаниях (Яндекс, Авито, X5 и т.п.) если проект работает с рекомендательными системами.
	Нужно уметь реализовывать алгоритм и записывать задачу математически, чтобы полностью разобраться в оптимизации алгоритма, функции ошибки и т.п.
</div>
</details>

<details>
<summary><b>Как работает градиентный бустинг</b></summary>
<div> <br />
	Работу данного алгоритма могут спросить на собесах в топ компаниях (Яндекс, Авито, X5 и т.п.) если проект работает с рекомендательными системами.
	Нужно уметь реализовывать алгоритм и записывать задачу математически, чтобы полностью разобраться в оптимизации алгоритма, функции ошибки и т.п.
</div>
